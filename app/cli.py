...
def main():
    ...
    header_parser = subparsers.add_parser(
        "headers", help="Check HTTP security headers")
    ...
    if args.command == "ports":
        ...
        save_results_to_s3(
            args.host, results, "cloud-scanner-results-250368538184", prefix="port_scans")

    elif args.command == "headers":
        results = header_checker.check_security_headers(
            header_checker.get_headers(args.host))
        header_checker.output_header_results(args.host, results)
        save_results_to_s3(
            args.host, results, "cloud-scanner-results-250368538184", prefix="header_checks")
        ...
        save_results_to_s3(
            args.bucket, results, "cloud-scanner-results-250368538184", prefix="s3_checks")
